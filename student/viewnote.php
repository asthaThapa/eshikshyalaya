							...
							<div class="single-post row">
								...
								<div class="col-lg-3  col-md-3 meta-details">
									<ul class="tags">
										...
										<li><a href="#">Time Value of Money</a></li>
									
									</ul>
									<div class="user-details row">
										<p class="user-name col-lg-12 col-md-12 col-6"><a href="#">Debindra Bhandari</a> <span class="lnr lnr-user"></span></p>
										<p class="date col-lg-12 col-md-12 col-6"><a href="#">12 Dec, 2017</a> <span class="lnr lnr-calendar-full"></span></p>
										
																														
									</div>
									<div style="margin:auto;">
										<a href="login.html" class="primary-btn text-uppercase">Download</a>	
								</div>	
 	
								</div>
								<div class="col-lg-9 col-md-9">
									<h3 class="mt-20 mb-20">Calculating Present Values</h3>
									<!-- <p class="excert">
										<h4> Details </h4>
