	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		if (isset($_POST['student'])) {
        	...
        	if ($db->count >= 1)
        	{
        		...
        		$_SESSION['login_student_error'] = "Wrong username or password.";
	    ...
	    if (isset($_POST['teacher'])) {
        	...
        	if ($db->count >= 1)
        	{
        		...
        		//redirect to main page with error
        		$_SESSION['login_teacher_error'] = "Wrong username or password.";
        		header('Location:index.php');
        		exit;
        	}
	    }
									...
									<div class="register-photo">
											<div class="form-container">
												<form method="post">
													...
													<?php if (isset($_SESSION['login_teacher_error'])){ ?>
														<p><?php echo $_SESSION['login_teachert_error']; ?></p>
													<?php } ?>
