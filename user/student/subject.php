...
if ($_SERVER['REQUEST_METHOD'] == 'GET'){
	...
	$db =  getDbInstance(); 
	$select = array('t_id');
	$db->where('subject', $subject);
	$row = $db->get('teachers');

	$teacherId = $row[0]['t_id'];
	...
	$select = array('id','teacher_id', 'chapter_no','chapter', 'title','summary','date', 'file_name', 'created_at');
	...
	$assignments = $db->arraybuilder()->paginate("teacher_assignments", $page, $select);
					...
					<div class="row">
						<div class="table1">
							<div class="single-price">
								<h1 style="text-align: center"><?php echo $_GET['subject']; ?></h1>
                    ...
                    <td>
                    	<ul class="price-list">
               			<li class="align-items-center">
										...
										<a href="view.php?id=<?php echo $row['id'];?>" class="price-btn" style="background-color:  #f8b600"> View </a>
									</li>	
						</ul>			
                </tr>
            <?php endforeach; ?>      
