							...
							<div class="comment-form col-lg-12">
								...
								<form method="POST" enctype="multipart/form-data">
									<div class="form-group form-inline">
									  ...
									  <div class="form-group col-lg-3	 col-md-12 email">
									  ...
									  <div class="form-group col-lg-3 col-md-12 email">
									    ...
									    <div class="form-group col-lg-3 col-md-12 email">
									    <input type="text" class="form-control" id="date" name="date" placeholder="Date" onfocus="this.placeholder = ''" onblur="this.placeholder = 'date'" required="">
									  </div>																			
									</div>
